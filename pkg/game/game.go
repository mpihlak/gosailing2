...
func (g *GameState) Draw(screen *ebiten.Image) {
	...
	g.Dashboard.Draw(screen, g.raceStarted, g.isOCS, g.timerDuration, g.elapsedTime, g.hasCrossedLine, g.secondsLate, g.speedPercentage, g.markRounded, g.raceFinished, courseName, g.CourseLeg, g.courseCompleted, g.gatePassedBetween, g.gateRoundChosen, g.gateRounded)
